            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>新增新闻</h2>
                        <div class="box-icon">
                        ...
                        <form class="form-horizontal" action="/back/news/add.do">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="writer" >
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >来源 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead"  name="source" >
                                    </div>
                                </div>
