            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>家庭个人信息修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/resident/modify.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >姓名</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="name" type="text" value="${resident.name}">
                                        <input class="input-xlarge focused" name="id" type="hidden" value="${resident.id}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >年龄</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="age" type="text" value="${resident.age}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >电话</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="phone" type="text" value="${resident.phone}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">家庭编号</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="familyId" type="text" value="${resident.familyId}" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea tabindex="3" class="input-xlarge span12" name="remark" rows="12" >${resident.remark}</textarea>
                                    </div>
                                </div>
