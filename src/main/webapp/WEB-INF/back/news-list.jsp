                    ...
                    <div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <c:forEach items="${news}" var="New">
                                <tr>
                                    <td>${New.title}</td>
                                    <td class="center">${New.writer}</td>
                                    <td class="center">${New.source}</td>
                                    <td class="center"><fmt:formatDate value="${New.time}" type="both"/></td>
                                    <td class="center">

                                        <a class="btn btn-info" href="/back/news/modifyPage.do?id=${New.id}">
                                            <i class="halflings-icon white edit"></i>
                                        </a>
                                        <a class="btn btn-danger" href="/back/news/delete.do?id=${New.id}">
