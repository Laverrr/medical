            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>流行病列表</h2>
                        <div class="box-icon">
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <c:forEach items="${diseases}" var="disease">
                                <tr>
                                    ...
                                    <td class="center">
                                        <c:choose>
                                            <c:when test="${disease.parentId==1}">
                                                <span class="label label-success">春季流行病</span>
                                            </c:when>
                                            <c:when test="${disease.parentId==2}">
                                                <span class="label label-important">夏季流行病</span>
                                            </c:when>
                                            <c:when test="${disease.parentId==3}">
                                                <span class="label label-warning">秋季流行病</span>
                                            </c:when>
                                            <c:otherwise>
                                                <span class="label">冬季流行病</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td class="center">

                                        <a class="btn btn-info" href="/back/disease/modifyPage.do?id=${disease.id}">
                                            <i class="halflings-icon white edit"></i>
                                        </a>
                                        <a class="btn btn-danger" href="/back/disease/delete.do?id=${disease.id}">
