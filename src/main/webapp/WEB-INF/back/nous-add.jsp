            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>新增医学常识</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/nous/add.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >常识名称 </label>
                                    <div class="controls">
