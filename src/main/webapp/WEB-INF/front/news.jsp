...
<div class="background">
    <div class="page">
        ...
        <div class="body">
            <div class="about">
                <div>
                    <c:forEach items="${pageInfo.list}" var="New">
                        <div>
                            <div>
                                <h3>${New.title}</h3>
                                <h6> &nbsp; &nbsp; &nbsp; &nbsp; 时间：<fmt:formatDate value="${New.time}" type="both"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;来源：${New.source}</h6>
                                <p>
                                        ${New.content}
                                </p>
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <c:if test="${pageInfo.hasPreviousPage}">
                                        <li>
                                            <a aria-hidden="true"
                                               href="/front/page/news.do?pageNum=${pageInfo.prePage}">&laquo;</a>
                                        </li>
                                    </c:if>

                                    <c:forEach begin="1" end="${pageInfo.pages}" var="pageIndex" step="1">
                                        <li <c:if test="${pageInfo.pageNum==pageIndex}">class="active"</c:if>><a
                                                href="/front/page/news.do?pageNum=${pageIndex}">${pageIndex}</a></li>
                                    </c:forEach>
                                    <c:if test="${pageInfo.hasNextPage}">
                                        <li>
                                            <a aria-hidden="true"
                                               href="/front/page/news.do?pageNum=${pageInfo.nextPage}">&raquo;</a>
                                        </li>
                                    </c:if>
