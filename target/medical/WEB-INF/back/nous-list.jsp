            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>医学常识列表</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <tbody>
                            <c:forEach items="${nous}" var="nou">
                                <tr>
                                    <td>${nou.name}</td>
                                    <td class="center">
                                        <a class="btn btn-info" href="/back/nous/modifyPage.do?id=${nou.id}">
                                            <i class="halflings-icon white edit"></i>
                                        </a>
                                        <a class="btn btn-danger" href="/back/nous/delete.do?id=${nou.id}">
