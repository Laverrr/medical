        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    ...
                    <a href="/back/page/nous.do">医学常识列表</a>
                    <i class="icon-angle-right"></i>
                </li>
                <li>
                    <i class="icon-plus-sign"></i>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>医学常识信息修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/nous/modify.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >常识标题 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="title"  value="${nous.name}">
                                        <input type="hidden" class="span6 typeahead" name="id"  value="${nous.id}">
                                    </div>
                                </div>
                                <div class="control-group hidden-phone">
                                    <label class="control-label" for="textarea2">常识内容</label>
                                    <div class="controls">
                                        <textarea class="cleditor" id="textarea2" name="content" rows="3">${nous.content}</textarea>
                                    </div>
                                </div>
