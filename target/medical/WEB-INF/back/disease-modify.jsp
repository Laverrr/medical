        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    ...
                    <a href="/back/page/disease.do">流行病列表</a>
                    <i class="icon-angle-right"></i>
                </li>
                <li>
                    <i class="icon-warning-sign"></i>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>流行病信息修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/news/add.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >流行病名 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="name"  value="${disease.name}">
                                        <input type="hidden" class="span6 typeahead" name="id"  value="${disease.id}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >季节分类</label>
                                    <div class="controls">
                                        <select name="parentId">
                                            <option value="1">春季流行病</option>
                                            <option value="2">夏季流行病</option>
                                            <option value="3">秋季流行病</option>
                                            <option value="4">冬季流行病</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="control-group hidden-phone">
                                    ...
                                    <div class="controls">
                                        <textarea class="cleditor" id="textarea2" name="des" rows="3">${disease.des}</textarea>
                                    </div>
                                </div>
