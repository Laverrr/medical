            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>家庭信息修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/family/modify.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >户主姓名</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="holderName" type="text" value="${family.holderName}">
                                        <input class="input-xlarge focused" name="id" type="hidden" value="${family.id}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >家庭住址</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="address" type="text" value="${family.address}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >人口数</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="num" type="text" value="${family.num}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">居住类型</label>
                                    <div class="controls">
                                        <select name="status">
