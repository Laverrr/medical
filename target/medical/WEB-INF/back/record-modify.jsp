            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>个人病历修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/record/modify.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label">患者姓名</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="id" type="hidden" value="${record.id}">
                                        <input class="input-xlarge focused" name="userName" type="text" value="${record.userName}" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >家庭编号</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="familyId" type="text" value="${record.familyId}" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >疾病名称</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="diseaseName" type="text" value="${record.diseaseName}" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >患病时间</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="diseaseTime" type="text" value="<fmt:formatDate value="${record.diseaseTime}" dateStyle="medium" />" readonly>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea tabindex="3" class="input-xlarge span12"  name="des" rows="6" placeholder="添加病情描述">${record.des}</textarea>
                                    </div>
                                </div>
