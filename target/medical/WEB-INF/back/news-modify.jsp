    ...
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <i class="icon-edit"></i>
                    <a href="/back/page/news.do">新闻列表</a>
                    <i class="icon-angle-right"></i>
                </li>
                <li>
                    <i class="icon-edit"></i>
            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>新闻信息修改</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/news/modify.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >新闻标题 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="title"  value="${news.title}">
                                        <input type="hidden" class="span6 typeahead" name="id"  value="${news.id}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >作者 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead" name="writer" value="${news.writer}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >来源 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead"  name="source" value="${news.source}">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" >时间 </label>
                                    <div class="controls">
                                        <input type="text" class="span6 typeahead"  name="source" value="<fmt:formatDate value="${news.time}" type="both"/>" readonly="readonly">
                                    </div>
                                </div>
                                <div class="control-group hidden-phone">
                                    <label class="control-label" for="textarea2">新闻内容</label>
                                    <div class="controls">
                                        <textarea class="cleditor" id="textarea2" name="content" rows="3">${news.content}</textarea>
                                    </div>
                                </div>
