            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white user"></i><span class="break"></span>家庭列表</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <table class="table table-striped table-bordered bootstrap-datatable datatable">
                            ...
                            <c:forEach items="${families}" var="family">
                                <tr>
                                    <td>${family.holderName}</td>
                                    <td class="center">${family.address}</td>
                                    <td class="center">${family.num}</td>
                                    <td class="center">
                                        <c:choose>
                                            <c:when test="${family.status==0}">
                                                常住
                                            </c:when>
                                            <c:otherwise>
                                                流动
                                    ...
                                    <td class="center">
                                        <a class="btn btn-success" href="/back/resident/list.do?familyId=${family.id}">
                                            <i class="halflings-icon white zoom-in"></i>
                                        </a>
                                        <a class="btn btn-info" href="/back/family/modifyPage.do?familyId=${family.id}">
                                            <i class="halflings-icon white edit"></i>
                                        </a>
                                        <a class="btn btn-danger" href="/back/family/delete.do?familyId=${family.id}">
