            ...
            <div class="row-fluid sortable">
                <div class="box span12">
                    <div class="box-header" data-original-title>
                        <h2><i class="halflings-icon white edit"></i><span class="break"></span>新增家庭</h2>
                        <div class="box-icon">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/back/family/add.do">
                            <fieldset>
                                <div class="control-group">
                                    <label class="control-label" >户主姓名</label>
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="holderName" type="text" >
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="input-xlarge focused" name="num" type="text" >
                                    </div>
                                </div>
                                <div class="control-group">
